...
Instrument* InstrumentManager::NewInstrument(u32 id){
	...
	inst->reverb->setParameterFloat(FMOD_DSP_SFXREVERB_DIFFUSION, 100.0);
	inst->reverb->setParameterFloat(FMOD_DSP_SFXREVERB_DENSITY, 100.0);
	// inst->reverb->setParameterFloat(FMOD_DSP_SFXREVERB_HFDECAYRATIO, 40.0);
	// inst->reverb->setParameterFloat(FMOD_DSP_SFXREVERB_HIGHCUT, 1000.0);
